...
<html
  ...
  <head>
    <title>Profile - Verifikator</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 mb-4"><span class="text-muted fw-light">Verifikator Profile /</span> Profile</h4>
                ...
                <div class="col-12">
                  <div class="card mb-4">
                    ...
                    <div class="user-profile-header d-flex flex-column flex-sm-row text-sm-start text-center mb-4">
                        <form id="uploadForm" action="{{ route('upload.profile.verifikator') }}" method="POST" enctype="multipart/form-data">
                          @csrf
