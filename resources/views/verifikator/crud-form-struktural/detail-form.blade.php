                ...
                <div class="col-md">
                    <div class="card">
                        <div class="col-md-12 d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('verifikasi.jabatan.struktural.edit', $form->id) }}" class="btn btn-primary" style="height: fit-content; padding: 15px 30px; margin-top: 20px; margin-right: 20px;">Verifikasi sekarang</a>
                        </div>
                      <div class="card-body">
                            <div class="mb-3">
