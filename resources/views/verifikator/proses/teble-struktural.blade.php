...
<html
  ...
  <head>
    <title>Proses Pengajuan jabatan struktural - Verifikator</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="py-3 mb-4">Proses Pengajuan Formulir usul kenaikan pangkat struktural</h4>
                <div class="row">
                    <!-- Default Wizard -->
                          ...
                          <form onSubmit="return false">
                            ...
                            <div id="account-details" class="content">
                                <div class="content-header mb-3">
                                    <h6 class="mb-0">Table Pending Formulir Usul Kenaikan Pangkat struktural</h6>
                            ...
                            <div id="personal-info" class="content">
                                <div class="content-header mb-3">
                                    <h6 class="mb-0">Table Ditolak Formulir Usul Kenaikan Pangkat struktural</h6>
                            ...
                            <div id="social-links" class="content">
                              <div class="content-header mb-3">
                                <h6 class="mb-0">Table Diterima Formulir Usul Kenaikan Pangkat struktural</h6>
