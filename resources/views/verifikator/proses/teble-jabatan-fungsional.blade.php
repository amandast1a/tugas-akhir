...
<html
  ...
  <head>
    <title>Proses Pengajuan jabatan fungsional - Verifikator</title>
                        ...
                        <div class="bs-stepper-content">
                          <form onSubmit="return false">
                            ...
                            <table class="table">
                                ...
                                <tbody class="table-border-bottom-0">
                                    @foreach ($Form_jabatan_fungsional->where('status', 'Pembuatan_SK_Berhasil') as $item)
                                        <tr>
                                            <td>{{ $item->user->nama }}</td>
                                            <td>{{ $item->nama }}</td>
                                            <td>{{ $item->nip }}</td>
                                ...
                                <div class="content-header mb-3">
                                  ...
                                  <div class="table-responsive text-nowrap">
                                      <table class="table">
                                          ...
                                          <tbody class="table-border-bottom-0">
                                              @foreach ($Form_jabatan_fungsional->where('status', 'Perbaikan') as $item)
                                              <tr>
                                                  <td>{{ $item->user->nama }}</td>
                                                  <td>{{ $item->nama }}</td>
                                                  <td>{{ $item->nip }}</td>
