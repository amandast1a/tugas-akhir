            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="card mb-3">
                    <div class="col-md-12 d-flex justify-content-between align-items-center">
                        <h5 class="card-header">Table Document kenaikan pangkat fungsional</h5>
                    </div>
                        ...
                        <div class="col-md-12 d-flex justify-flex-start align-items-center">
                            ...
                            <div class="col-lg-3"  style="display: flex; align-items: center; height: fit-content; margin-right: 10px;">
                                ...
                                <select id="status" class="form-select" name="status">
                                    ...
                                    <option value="{{ $status1->status }}" {{ old('status') === $status1->status ? 'selected' : '' }}>
                                        {{ $status1->status }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-lg-3"  style="display: flex; align-items: center; height: fit-content; margin-right: 10px;">
                                ...
                                <select id="kecamatan" class="form-select" name="kecamatan">
                                    ...
                                    @foreach ($kecamatan1 as $kecamatan1)
                                    <option value="{{ $kecamatan1->kecamatan }}" {{ old('kecamatan') === $kecamatan1->kecamatan ? 'selected' : '' }}>
                ...
                <div class="card mb-3">
                    <div class="col-md-12 d-flex justify-content-between align-items-center">
                        <h5 class="card-header">Table Document kenaikan pangkat regular</h5>
                    </div>
                        ...
                        <div class="col-md-12 d-flex justify-flex-start align-items-center">
                            ...
                            <div class="col-lg-3"  style="display: flex; align-items: center; height: fit-content; margin-right: 10px;">
                                ...
                                <select id="status" class="form-select" name="status">
                                    ...
                                    <option value="{{ $status2->status }}" {{ old('status') === $status2->status ? 'selected' : '' }}>
                                        {{ $status2->status }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-lg-3"  style="display: flex; align-items: center; height: fit-content; margin-right: 10px;">
                                ...
                                <select id="kecamatan" class="form-select" name="kecamatan">
                                    ...
                                    <option value="{{ $kecamatan2->kecamatan }}" {{ old('kecamatan') === $kecamatan2->kecamatan ? 'selected' : '' }}>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <form action="{{ route('form-jabatan-regular.delete', $item->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                ...
                <div class="card mb-3">
                    <div class="col-md-12 d-flex justify-content-between align-items-center">
                        <h5 class="card-header">Table Document kenaikan pangkat ijazah</h5>
                    </div>
                    <form action="{{ route('document.pengusul.search') }}" method="GET">
                        @csrf
                            ...
                            <div class="col-lg-4"  style="display: flex; align-items: center; height: fit-content; margin-right: 10px;">
                                ...
                                <div class="col-lg-3"  style="display: flex; align-items: center; height: fit-content; margin-right: 10px;">
                                    ...
                                    <select id="status" class="form-select" name="status">
                                        ...
                                        <option value="{{ $status3->status }}" {{ old('status') === $status3->status ? 'selected' : '' }}>
                                            {{ $status3->status }}
                                        </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-lg-3"  style="display: flex; align-items: center; height: fit-content; margin-right: 10px;">
                                    ...
                                    <select id="kecamatan" class="form-select" name="kecamatan">
                                        ...
                                        <option value="{{ $kecamatan3->kecamatan }}" {{ old('kecamatan') === $kecamatan3->kecamatan ? 'selected' : '' }}>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <form action="{{ route('form-jabatan-ijazah.delete', $item->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                ...
                <div class="card mb-3">
                    <div class="col-md-12 d-flex justify-content-between align-items-center">
                        <h5 class="card-header">Table Document kenaikan pangkat struktural</h5>
                    </div>
                    <form action="{{ route('document.pengusul.search') }}" method="GET">
                        @csrf
                        ...
                        <div class="col-md-12 d-flex justify-flex-start align-items-center">
                            <div class="col-lg-4"  style="display: flex; align-items: center; height: fit-content; margin-right: 10px;">
                                ...
                                <div class="col-lg-3"  style="display: flex; align-items: center; height: fit-content; margin-right: 10px;">
                                    ...
                                    <select id="status" class="form-select" name="status">
                                        <option value="" disabled selected>pilih status</option>
                                        @foreach ($status4 as $status4)
                                        <option value="{{ $status4->status }}" {{ old('status') === $status4->status ? 'selected' : '' }}>
                                            {{ $status4->status }}
                                        </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-lg-3"  style="display: flex; align-items: center; height: fit-content; margin-right: 10px;">
                                    ...
                                    <select id="kecamatan" class="form-select" name="kecamatan">
                                        <option value="" disabled selected>Pilih SKPD</option>
                                        @foreach ($kecamatan4 as $kecamatan4)
                                        <option value="{{ $kecamatan4->kecamatan }}" {{ old('kecamatan') === $kecamatan4->kecamatan ? 'selected' : '' }}>
                                            {{ $kecamatan4->kecamatan }}
                                        </option>
                                        @endforeach
                                    </select>
                                  </div>
                    ...
                    <table class="table">
                        ...
                        <tbody class="table-border-bottom-0">
                            @foreach ( $Form_struktural as $item )
                            <tr>
                                <td>{{ $item->nama }}</td>
                                <td>{{ $item->nip }}</td>
                                <td>{{ $item->jabatan }}</td>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <form action="{{ route('form-jabatan-struktural.delete', $item->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
