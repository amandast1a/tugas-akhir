  ...
  <body>
                      ...
                      <div class="card-body">
                        <form action="{{ route('golongan.update', $golongan->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        <label for="defaultInput" class="form-label">golongan</label>
                                        <input id="defaultInput" name="golongan" class="form-control" type="text" placeholder="golongan" value="{{ old('golongan', $golongan->golongan) }}" autofocus />
                                        @error('golongan')
    ...
    <script>
        $(document).on('click', '.submit', function(e){
            ...
            Swal.fire({
            title: "Simpan golongan?",
            text: "golongan yang anda simpan bisa di edit kembali",
            icon: "question",
            ...
            if (result.isConfirmed) {
                form.submit();
                Swal.fire({
                title: "golongan berhasil disimpan",
