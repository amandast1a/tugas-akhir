  ...
  <body>
                      ...
                      <div class="card-body">
                        <form action="{{ route('kecamatan.update', $kecamatan->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        <label for="defaultInput" class="form-label">kecamatan</label>
                                        <input id="defaultInput" name="kecamatan" class="form-control" type="text" placeholder="kecamatan" value="{{ old('kecamatan', $kecamatan->kecamatan) }}" autofocus />
                                        @error('kecamatan')
    ...
    <script>
        $(document).on('click', '.submit', function(e){
            ...
            Swal.fire({
            title: "Simpan kecamatan?",
            text: "kecamatan yang anda simpan bisa di edit kembali",
            icon: "question",
            ...
            if (result.isConfirmed) {
                form.submit();
                Swal.fire({
                title: "kecamatan berhasil disimpan",
