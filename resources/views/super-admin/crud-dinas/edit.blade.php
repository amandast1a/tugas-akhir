  ...
  <body>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="col-md">
                    <div class="card">
                      <h5 class="card-header">dinas</h5>
                      <div class="card-body">
                        <form action="{{ route('dinas.update', $dinas->id) }}" method="post" enctype="multipart/form-data">
                            @method('put')
                            @csrf
                            <div class="card mb-4">
                                <h5 class="card-header">Edit dinas</h5>
                                <div class="card-body">
                                    <div class="mb-3">
                                        <label for="defaultInput" class="form-label">dinas</label>
                                        <input id="defaultInput" name="dinas" class="form-control" type="text" placeholder="dinas" value="{{ old('dinas', $dinas->dinas) }}" autofocus />
                                        @error('dinas')
    ...
    <script>
        $(document).on('click', '.submit', function(e){
            ...
            Swal.fire({
            title: "Simpan dinas?",
            text: "dinas yang anda simpan bisa di edit kembali",
            icon: "question",
