  ...
  <body>
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <input id="defaultInput" name="periode" class="form-control" type="text" placeholder="periode" value="{{ old('periode', $periode->periode) }}" autofocus />
                                        @error('periode')
    ...
    <script>
        $(document).on('click', '.submit', function(e){
            ...
            text: "periode yang anda simpan bisa di edit kembali",
            icon: "question",
            ...
            if (result.isConfirmed) {
                form.submit();
                Swal.fire({
                title: "periode berhasil disimpan",
