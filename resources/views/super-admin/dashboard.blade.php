                                ...
                                <div class="card h-100">
                                    <div class="card-header d-flex justify-content-between">
                                        ...
                                        <small class="text-muted">Updated
                                            {{ $Form_jabatan_fungsional ? $Form_jabatan_fungsional->updated_at->diffForHumans() : 'N/A' }}</small>
                                    </div>
                                ...
                                <div class="card h-100">
                                    <div class="card-header d-flex justify-content-between">
                                        ...
                                        <small class="text-muted">
                                            Updated
                                            {{ $Form_regular ? $Form_regular->updated_at->diffForHumans() : 'N/A' }}
                                        </small>
                            ...
                            <div id="statistic" class="col-lg-12 mb-4 col-md-12">
                                <div class="card h-100">
                                    <div class="card-header d-flex justify-content-between">
                                        ...
                                        <small class="text-muted">Updated
                                            {{ $Form_struktural ? $Form_struktural->updated_at->diffForHumans() : 'N/A' }}</small>
                                    </div>
                                    <div class="card-body pt-2">
                                        <div class="row gy-3">
                                            <div class="col-md-3 col-6">
                            ...
                            <div id="statistic" class="col-lg-12 mb-4 col-md-12">
                                <div class="card h-100">
                                    <div class="card-header d-flex justify-content-between">
                                        ...
                                        <small class="text-muted">Updated
                                            {{ $Form_ijazah ? $Form_ijazah->updated_at->diffForHumans() : 'N/A' }}</small>
                                    </div>
                                    <div class="card-body pt-2">
                                        <div class="row gy-3">
                                            <div class="col-md-3 col-6">
