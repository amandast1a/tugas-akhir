...
<html
    ...
    <head>
        <title>Formulir usul kenaikan pangkat fungsional</title>
    ...
    <body>
        ...
        <div class="layout-container">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="col-md">
                    <div class="card">
                        <h5 class="card-header">Formulir usul kenaikan pangkat fungsional</h5>
                        <div class="card-body">
                            <form class="needs-validation" action="{{ route('jabatan.fungsional.update', $form->id) }}" method="POST" enctype="multipart/form-data" novalidate>
                                @csrf
                                @method('PUT')
                                <div class="mb-3">
                                ...
                                @foreach ([
                                    ...
                                    'doc_skPangkat' => 'SK PANGKAT TERAKHIR',
                                    'doc_pakKonvensional' => 'PAK KONVENSIONAL (PAK Terakhir)',
                                    ...
                                    'doc_jabatanLama' => 'SK JABATAN FUNGSIONAL LAMA',
                                    'doc_jabatanTerakhir' => 'SK JABATAN FUNGSIONAL TERAKHIR',
                                    'doc_pendidik' => 'SERTIFIKAT PENDIDIK (Bagi Guru)',
                                    'doc_uji' => 'SERTIFIKAT UJI KOMPETENSI (Bagi yang naik jenjang)',
                                ] as $field => $label)
                                    <div class="mb-3">
                                        <label class="form-label" for="{{ $field }}">{{ $label }}</label>
                                        <input type="file" class="form-control" id="{{ $field }}" name="{{ $field }}" accept="application/pdf" />
                                        @if ($form->$field)
                                            <small>Current file: <a href="{{ asset('assets/documentJabatans/' . $form->$field) }}" target="_blank">View current file</a></small>
                                        @endif
                                    </div>
                                @endforeach
                                <div class="row">
