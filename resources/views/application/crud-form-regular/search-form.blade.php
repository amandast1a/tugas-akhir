            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="card">
                    <div class="col-md-12 d-flex justify-content-between align-items-cente">
                        ...
                        <a href="/proses-table-regular" class="btn btn-outline-primary" style="height: fit-content; padding: 15px 30px 15px 30px; margin-top: 20px;">Lihat Proses</a>
                    ...
                    <form action="{{ route('jabatan.regular.search') }}" method="GET">
