...
<html
  ...
  <head>
    <title>Formulir usul kenaikan pangkat struktural - Pengusul</title>
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="card">
                    <div class="col-md-12 d-flex justify-content-between align-items-cente">
                        <h5 class="card-header">Table Formulir usul kenaikan pangkat struktural</h5>
                    ...
                    <table class="table">
                        ...
                        <tbody class="table-border-bottom-0">
                            @forelse ($Form_struktural as $item )
                                <tr>
                                    <td>{{ $item->nama }}</td>
                                    <td>{{ $item->nip }}</td>
                                    <td>{{ $item->jabatan }}</td>
