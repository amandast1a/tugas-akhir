        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="py-3 mb-4">Proses Pengajuan Formulir usul kenaikan pangkat jabatan regular</h4>
                <div class="row">
                    <!-- Default Wizard -->
                          ...
                          <form onSubmit="return false">
                            ...
                            <div id="account-details" class="content">
                                <div class="content-header mb-3">
                                    <h6 class="mb-0">Table Pending Formulir usul kenaikan pangkat jabatan regular</h6>
                                ...
                                <table class="table">
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        @foreach ($Form_regular->where('status', 'Pending') as $item)
                                        <tr>
                                            <td>{{ $item->nama }}</td>
                                            <td>{{ $item->nip }}</td>
                                            <td>{{ $item->jabatan }}</td>
                            ...
                            <div id="personal-info" class="content">
                                <div class="content-header mb-3">
                                    <h6 class="mb-0">Table Revisi Formulir usul kenaikan pangkat jabatan regular</h6>
                                ...
                                <table class="table">
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        @foreach ($Form_regular->where('status', 'Ditolak') as $item)
                                        <tr>
                                            <td>{{ $item->nama }}</td>
                                            <td>{{ $item->nip }}</td>
                                            <td>{{ $item->jabatan }}</td>
                            ...
                            <div id="social-links" class="content">
                              <div class="content-header mb-3">
                                <h6 class="mb-0">Table Diterima Formulir usul kenaikan pangkat jabatan regular</h6>
                            ...
                            <table class="table">
                                ...
                                <tbody class="table-border-bottom-0">
                                    @foreach ($Form_regular->where('status', 'Pembuatan_SK_Berhasil') as $item)
                                        <tr>
                                            <td>{{ $item->nama }}</td>
                                            <td>{{ $item->nip }}</td>
                                            <td>{{ $item->jabatan }}</td>
                                ...
                                <div class="content-header mb-3">
                                  ...
                                  <div class="table-responsive text-nowrap">
                                      <table class="table">
                                          ...
                                          <tbody class="table-border-bottom-0">
                                              @foreach ($Form_regular->where('status', 'Perbaikan') as $item)
                                              <tr>
                                              ...
                                              me-1">{{ $item->status }}</span>
                                                  ...
                                                  <td>{{ $item->time }}</td>
                                                  <td>
                                                    <a href="{{ route('jabatan.regular.edit', $item->id) }}" class="btn btn-outline-primary">Perbaiki</a>
                                                  </td>
                                              </tr>
                                              @endforeach
                                          </tbody>
