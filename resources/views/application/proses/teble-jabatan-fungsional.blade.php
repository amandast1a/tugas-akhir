                          ...
                          <form onSubmit="return false">
                            ...
                            <div id="account-details" class="content">
                                ...
                                <table class="table">
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        @foreach ($formJabatanFungsional->where('status', 'Pending') as $item)
                                        <tr>
                                            <td>{{ $item->nama }}</td>
                                            <td>{{ $item->nip }}</td>
                                            <td>{{ $item->jabatan }}</td>
                            ...
                            <div id="personal-info" class="content">
                                ...
                                <table class="table">
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        @foreach ($formJabatanFungsional->where('status', 'Ditolak') as $item)
                                        <tr>
                                            <td>{{ $item->nama }}</td>
                                            <td>{{ $item->nip }}</td>
                                            <td>{{ $item->jabatan }}</td>
                            ...
                            <table class="table">
                                ...
                                <tbody class="table-border-bottom-0">
                                    @foreach ($formJabatanFungsional->where('status', 'Pembuatan_SK_Berhasil') as $item)
                                        <tr>
                                            <td>{{ $item->nama }}</td>
                                            <td>{{ $item->nip }}</td>
                                            <td>{{ $item->jabatan }}</td>
                            ...
                            <div id="refresh-links" class="content">
                                <div class="content-header mb-3">
                                  <h6 class="mb-0">Table Perbaikan Formulir Usul Kenaikan Pangkat Fungsional</h6>
                                  ...
                                  <div class="table-responsive text-nowrap">
                                      <table class="table">
                                          ...
                                          <tbody class="table-border-bottom-0">
                                              @foreach ($formJabatanFungsional->where('status', 'Perbaikan') as $item)
                                              <tr>
                                              ...
                                              me-1">{{ $item->status }}</span>
                                                  ...
                                                  <td>{{ $item->time }}</td>
                                                  <td>
                                                    <a href="{{ route('jabatan.fungsional.edit', $item->id) }}" class="btn btn-outline-primary">Perbaiki</a>
                                                  </td>
                                              </tr>
                                              @endforeach
                                          </tbody>
