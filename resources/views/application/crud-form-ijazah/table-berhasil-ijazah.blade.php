...
<html
  ...
  <head>
    <title>Table berhasil formulir usul kenaikan pangkat ijazah - Pengusul</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="py-3 mb-4"><span class="text-muted fw-light">Forms/</span>Table berhasil formulir usul kenaikan pangkat ijazah</h4>
                <!-- Basic Bootstrap Table -->
                <div class="card">
                    <div class="col-md-12 d-flex justify-content-between align-items-cente">
                        <h5 class="card-header">Table berhasil formulir usul kenaikan pangkat ijazah</h5>
                        ...
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalLabel1">Formulir usul kenaikan pangkat ijazah</h5>
                              <button
                                type="button"
                                class="btn-close"
