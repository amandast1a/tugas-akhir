            ...
            <div class="card" style="width: fit-content;">
                ...
                <div class="app-brand justify-content-center mb-4 mt-2" style="width: fit-content;">
                    ...
                    <span class="app-brand-logo demo">
                        <img src="{{ asset('assets/') }}/img/favicon/logo.png" alt="" width="60px" height="40px">
                    </span>
                    <span class="app-brand-text demo text-body fw-bold ms-1" style="font-size: 16px; width: 280px;">PENGELOLAAN DAN PEMANTAUAN KENAIKAN PANGKAT</span>
                    </a>
                </div>
                <!-- /Logo -->
                <h4 class="mb-1 pt-2">Selamat Datang</h4>
                <p class="mb-4">Silahkan masuk ke akun Anda dan semoga berhasil</p>
