            ...
            <ul class="menu-sub">
                <li class="menu-item {{ Request::is('table-regular') ? 'active' : '' }}">
                    <a href="/table-regular" class="menu-link">
                        <div data-i18n="Formulir usul kenaikan pangkat reguler">Formulir usul kenaikan pangkat reguler
                        </div>
                    </a>
                </li>
                <li class="menu-item {{ Request::is('table-jabatan-fungsional') ? 'active' : '' }}">
                    <a href="/table-jabatan-fungsional" class="menu-link">
                        <div data-i18n="Formulir usul kenaikan pangkat jabatan fungsional">Formulir usul kenaikan
                            pangkat jabatan fungsional</div>
                    </a>
                </li>
                <li class="menu-item {{ Request::is('table-jabatan-struktural') ? 'active' : '' }}">
                    <a href="/table-jabatan-struktural" class="menu-link">
                        <div data-i18n="Formulir usul kenaikan pangkat jabatan struktural">Formulir usul kenaikan
                            pangkat jabatan struktural</div>
                    </a>
                </li>
                <li class="menu-item {{ Request::is('table-jabatan-ijazah') ? 'active' : '' }}">
                    <a href="/table-jabatan-ijazah" class="menu-link">
                        <div data-i18n="Formulir usul kenaikan pangkat penyesuaian ijazah">Formulir usul kenaikan
                            pangkat penyesuaian ijazah</div>
                    </a>
                </li>
            </ul>
        </li>
            ...
            <ul class="menu-sub">
                <li class="menu-item {{ Request::is('proses-table-regular') ? 'active' : '' }}">
                    <a href="/proses-table-regular" class="menu-link">
                        <div data-i18n="Proses Formulir usul kenaikan pangkat reguler">Formulir usul kenaikan pangkat
                            reguler</div>
                    </a>
                </li>
                <li class="menu-item {{ Request::is('proses-table-jabatan-fungsional') ? 'active' : '' }}">
                    <a href="/proses-table-jabatan-fungsional" class="menu-link">
                        <div data-i18n="Proses Formulir usul kenaikan pangkat jabatan fungsional">Proses Formulir usul
                            kenaikan pangkat jabatan fungsional</div>
                    </a>
                </li>
                <li class="menu-item {{ Request::is('proses-table-struktural') ? 'active' : '' }}">
                    <a href="/proses-table-struktural" class="menu-link">
                        <div data-i18n="Proses Formulir usul kenaikan pangkat jabatan struktural">Proses Formulir usul
                            kenaikan pangkat jabatan struktural</div>
                    </a>
                </li>
                <li class="menu-item {{ Request::is('proses-table-ijazah') ? 'active' : '' }}">
                    <a href="/proses-table-ijazah" class="menu-link">
                        <div data-i18n="Proses Formulir usul kenaikan pangkat penyesuaian ijazah">Proses Formulir usul
                            kenaikan pangkat penyesuaian ijazah</div>
                    </a>
                </li>
            </ul>
        </li>
